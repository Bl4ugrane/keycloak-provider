...
public class UpdateOrganization implements RequiredActionProvider, RequiredActionFactory {
    ...
    public void processAction(RequiredActionContext context) {
        try {
            String url = context.getAuthenticationSession().getAuthNote(Constants.URL);
            ...
            restClient.send(url, new RequestDto(mobileNumber, organizationId, organizationType, inn, mobileNumber));
            context.success();
